<template>
  <div :class="{ 'dark-theme': isDarkMode }">
    <header class="app-header shadow-lg" style="background-color: var(--highlight-color, #4f46e5);">
    ...
    <main class="container mx-auto px-4 py-8" style="min-height: calc(100vh - 4rem);">
      <router-view />
    </main>
  </div>
</template>
